...
export class Tab1Page {
  ...
  produtos = [
    ...
    },
    {
      ...
      descricao: 'Sumo natural preparado na hora com laranjas frescas, ideal para acompanhar qualquer refeição.',
      ingredientes: [
        'laranja',
        'gelo'
      ],
    ...
    },
    {
      ...
      pontos: 5,
      destaque: false,
      imagem: 'https://images.unsplash.com/photo-1523677011781-c91d1bbe2f9e',
      descricao: 'Bebida fresca e leve, preparada com limão, água e hortelã.',
      ingredientes: [
        'limão',
        'água',
        'hortelã',
    ...
    },
    {
      ...
      pontos: 2,
      destaque: false,
      imagem: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd',
      descricao: 'Café expresso intenso e aromático, perfeito para terminar a refeição.',
      ingredientes: [
        'café'
      ],
      ingredientesPersonalizaveis: []
    },
    {
      ...
      pontos: 2,
      destaque: false,
      imagem: 'https://images.unsplash.com/photo-1534778101976-62847782c213',
      descricao: 'Cappuccino suave preparado com bebida vegetal e café aromático.',
      ingredientes: [
        'café',
        'bebida vegetal',
        'canela'
